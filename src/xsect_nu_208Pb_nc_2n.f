***********************************************************************
*  Filename: xsect_nu_208Pb_nc_2n.f
***********************************************************************
*
*  Inputs:
...
***********************************************************************
      ...
      SUBROUTINE xsect_nu_208Pb_nc_2n(interaction,E_nu,xsect_total)
...
C  Local Variable Declarations
      ...
      PARAMETER (xs_data_entries = xs_nu_208Pb_nc_Engel_2n_entries)  ! from 'xsect_size'
...
************************************************************************
     ...
     +     d_nubar_xs          /aspline_size * 0./
      ...
      xs_data_file = 'dat/xsect/xs_nu_208Pb_nc_Engel_2n.dat'
...
c            WRITE (*,*) '  --> xs_nu_208Pb_nc.f: filling data arrays...' 
            ...
            DO 20 i = 1, xs_data_entries
               READ (50,*) E_data(i), xs_nu_data(i), xs_nubar_data(i)

C               WRITE (*,*) E_data(i), xs_nu_data(i), xs_nubar_data(i)
...
C            WRITE (*,*) b_nu_xs, c_nu_xs, d_nu_xs
...
*****************************************************************************
     ...
     +              .OR. interaction .EQ. 99) THEN
            ...
            CALL aspline_eval(xs_data_entries,E_data,xs_nubar_data,
     +                        b_nubar_xs,c_nubar_xs,d_nubar_xs,
     +                        E_nu,xsect_fit)
