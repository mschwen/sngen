...
***********************************************************************
      ...
      SUBROUTINE xsect_nu_12C_nc(interaction,E_nu,xsect_total)
...
C  Local Variable Declarations
      ...
      PARAMETER (xs_data_entries = xs_nu_12C_entries)  ! from 'xsect_size'
...
************************************************************************
     ...
     +     d_nubar_xs          /aspline_size * 0./
      ...
      xs_data_file = 'dat/xsect/xs_nu_12C_nc.dat'
...
c            WRITE (*,*) '  --> xs_nu_12C_nc.f: filling data arrays...' 
