...
***********************************************************************
      ...
      SUBROUTINE xsect_nu_12C_cc(interaction,E_nu,xsect_total)
...
************************************************************************
     ...
     +     d_nubar_xs          /aspline_size * 0./
      ...
      xs_data_file = 'dat/xsect/xs_nu_12C_cc.dat'
...
c            WRITE (*,*) '  --> xs_nu_12C_cc.f: filling data arrays...' 
